...
## 13. SISTEMA DE PAGAMENTOS - STATUS: ESTRUTURA PREPARADA (NÃO IMPLEMENTADO)

**⚠️ IMPORTANTE**: O sistema possui toda a estrutura preparada para integração com Efí Bank, incluindo controllers, services, views e configurações. Porém, a integração não está ativa. Pedidos são criados sem processamento de pagamento real.

### 13.1 Integração Efí Bank (Preparada)
```
┌─────────────────────────────────────────────────────────────────┐
│                    INTEGRAÇÃO EFÍ BANK                          │
│                  (Antigo Gerencianet)                           │
...
│ 6. Limpa carrinho                                             │
│ 7. Pedido criado com status 'pending' (SEM PAGAMENTO REAL)    │
│ 8. Redireciona para dashboard (pagamento não implementado)    │
└───────────────────────────────────────────────────────────────┘
                        ↓
...
✓ Estrutura preparada para gateway de pagamento (Efí Bank - não implementado)
